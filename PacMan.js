...
let direction = 0;
const PacMan = []; // This array holds all the pacmen
...
function checkCollisions(item) {
  ...
  if(item.position.x+item.velocity.y+item.newimg.height>window.innerHeight||item.position.y+item.velocity.y<0)
